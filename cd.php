...
if (isset($_POST['registro'])) {
    if(
       ...
       )
     {
            ...
            $fecha = date("d/m/y");
            $consulta = "INSERT INTO datos(nome_completo, email, senha, confirmar_senha, telefone, cep, endereco_entrega, tipo_residencia, fecha) VALUES('$nome_completo', '$email', '$senha', '$confirmar_senha', '$telefone', '$cep', '$endereco_entrega', '$tipo_residencia', '$fecha')";
